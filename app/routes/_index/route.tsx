...
export const meta: MetaFunction = () => {
  return [
    { title: "Livia" },
    { name: "description", content: "Welcome to Livia!" },
  ];
};
...
export default function App() {
  ...
  const { isOpen: isSignInOpen, onOpen: onSignInOpen, onOpenChange: onSignInOpenChange } = useDisclosure();

  return (
    <>
      <Header onSignInOpen={onSignInOpen} isLogged={!!data.user} />

      <main className="prose p-8 mx-auto max-w-2xl">
        <article>
      ...
      <SignInModal isOpen={isSignInOpen} onOpenChange={onSignInOpenChange} />
    </>
  );
}
